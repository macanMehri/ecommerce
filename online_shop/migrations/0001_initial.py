    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('percentage', models.IntegerField(validators=[online_shop.models.validate_percentage], verbose_name='Percentage')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=False, verbose_name='Is active')),
                ('title', models.CharField(max_length=255, verbose_name='Title')),
                ('raw_price', models.FloatField(validators=[online_shop.models.validate_positive], verbose_name='Price')),
                ('description', models.TextField(verbose_name='Description')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='online_shop.category', verbose_name='Category')),
                ('discount', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to='online_shop.discount', verbose_name='Discount')),
